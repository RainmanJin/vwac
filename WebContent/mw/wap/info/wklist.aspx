<%@ Page Title="" Language="C#" MasterPageFile="~/mw/wap/Wap.Master" AutoEventWireup="true" CodeBehind="wklist.aspx.cs" Inherits="PortalWeb.mw.wap.Info.wklist" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <div class="header"><h2>微课程</h2><img src="<%=MW.BasePage.GetWebPath %>/mw/wap/images/header.jpg"/></div>
     ...
     function loadpage(p) {
         $.post(document.location.href, { "page": p, "cmd": "list" }, function (result) {
             ...
             $.each(data, function (j, o) {
                 ...
                 var url = o["ShareUsers"] == "" ? "<%=MW.BasePage.GetWebPath %>/mw/wap/info/wkview.aspx?id=" + o["Id"] : o["ShareUsers"];
                 _html += '<li ' + video + '><a href="' + url + '"><img src="' + o["A4"] + '"><span><p>' + o["Title"] + '</p><time>' + t + '</time></span></a></li>';
             });
