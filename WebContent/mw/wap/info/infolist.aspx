        ...
        function loadpage(p) {
            $.post(document.location.href, { "page": p, "cmd": "list" }, function (result) {
                ...
                $.each(data, function (j, o) {
                    ...
                    var url = o["ShareUsers"] == "" ? "<%=MW.BasePage.GetWebPath %>/mw/wap/info/infoview.aspx?id=" + o["Id"] : o["ShareUsers"];
                    _html += '<li ' + video + '><a href="'+url+'"><img src="' + o["FilePath"] + '"><span><p>' + o["Title"] + '</p><time>' + t + '</time></span></a></li>';
             });
