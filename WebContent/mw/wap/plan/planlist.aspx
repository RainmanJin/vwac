          ...
          <table border="0" cellpadding="1" cellspacing="1" class="Calendar" id="caltable">
            <thead>
              <tr align="center" valign="middle">
                <td colspan="7" class="Title"><a href="javaScript:subMonth();" title="上一月" Class="DayButton"><img src="<%=MW.BasePage.GetWebPath %>/mw/wap/images/dateL.png" style=" margin-right:40px;" /></a>
                  ...
                  <strong>月</strong> <a href="JavaScript:addMonth();" title="下一月" Class="DayButton nextmonth"><img src="<%=MW.BasePage.GetWebPath %>/mw/wap/images/dateR.png"  style=" margin-left:40px;"/></a></td>
              </tr>
              <tr align="center" valign="middle"> 
