...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="header"><div class="menu_control menu_control_h"><a href="javascript:;"></a></div><h2><%=typename %>排期查询</h2><img src="<%=MW.BasePage.GetWebPath %>/mw/wap/images/header.jpg"/></div>
    <div class="page2">
    <div class="main">
