<%@ Page Title="" Language="C#" MasterPageFile="~/mw/DefaultDetail.Master" AutoEventWireup="true" CodeBehind="~/mw/vwtestdrive/_userdialog.aspx.cs" Inherits="PortalWeb.mw.vwtestdrive._userdialog" %>
    ...
    <script>
        ...
        function GetValue() {
            ...
            if (strlist.options.length > 0) {
                ...
                var strtxt1 = $("#<%=hideradio.ClientID%>").val();//txt隐藏域的值
                parent.$("#" + strtxt1).val(txt);
                var strValue1 = $("#<%=hideid.ClientID%>").val();//value隐藏域的值
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                      ...
                      <asp:HiddenField ID="hideid" runat="Server" Value="0" />
                       <asp:HiddenField ID="hideradio" runat="Server" Value="0" />
                </table>
            </div>
</asp:Content>
