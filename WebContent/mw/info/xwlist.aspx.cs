...
{
    public partial class xwlist : System.Web.UI.Page
    {
        ...
        private void BindList()
        {
            ...
            rpt_List.PageLink = "xwlist.aspx?Search=Yes&pageid=" + PageID + "&TypeId=" + typeid + "&SearchName=" + Utils.UrlEncode(SearchName);
        ...
        {
            StringBuilder builder = new StringBuilder("xwlist.aspx?Search=Yes&pageid=" + PageID + "");
