...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="h_operate" style="padding-top: 5px;">
       ...
       &nbsp;&nbsp; <iframe src="../ashx/_upload.aspx?filepath=/UpLoads/fj/&recievetxtname=<%=txtFj.ClientID %>&filetype=fj&filesize=409600"
             ...
             <tr><td class="td_title"> 发布时间：</td>
        <td class="td_content"> <asp:TextBox ID="txtBeginTime" runat="server" OnClick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd'})"
    ...
    <div id="h_bottom">
        <%--<asp:UpdatePanel ID="UpdatePanel2" runat="server">
            <contenttemplate>--%>
        <asp:HiddenField runat="server" ID="hidurl" Value=""/>
