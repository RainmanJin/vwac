<%@ Page Title="" Language="C#" MasterPageFile="~/mw/Default.Master" AutoEventWireup="true" CodeBehind="homenew.aspx.cs" Inherits="PortalWeb.mw.Info.homenew" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <table border="0" cellspacing="0"width="100%" id="table1">
            <tr class="daohang_title">
                <td style="text-align: right;">
                     ...
                     <input id="Button2" type="button" value="新 增" class="btnlistOver" onclick="javascript: location.href = 'infodetail.aspx?pageid=<%=PageID%>'" />
                  </td>
            </tr>
            <tr>
                <td colspan="2">
    ...
    <script type="text/javascript">
        function _Copy(id) {
            var url = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=<%=WxBase.AppId%>&redirect_uri=<%=WxBase.SiteUrl%>/mw/wap/oauth2.ashx&response_type=code&scope=snsapi_base&state=info_" + id + "#wechat_redirect";
