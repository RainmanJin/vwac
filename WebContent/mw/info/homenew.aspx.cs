...
namespace PortalWeb.mw.Info
{
    public partial class homenew : System.Web.UI.Page
    {
        ...
        private void BindList()
        {
            ...
            rpt_List.PageLink = "homenew.aspx?Search=Yes&pageid=" + PageID + "&TypeId=" + typeid + "&SearchName=" + Utils.UrlEncode(SearchName);
        ...
        {
            StringBuilder builder = new StringBuilder("homenew.aspx?Search=Yes&pageid=" + PageID + "");
