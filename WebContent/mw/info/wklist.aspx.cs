...
{
    public partial class WkList : System.Web.UI.Page
    {
        ...
        private void BindList()
        {
            ...
            rpt_List.PageLink = "wklist.aspx?Search=Yes&pageid=" + PageID + "&TypeId=" + typeid + "&SearchName=" + Utils.UrlEncode(SearchName);
        ...
        {
            StringBuilder builder = new StringBuilder("wklist.aspx?Search=Yes&pageid=" + PageID + "");
