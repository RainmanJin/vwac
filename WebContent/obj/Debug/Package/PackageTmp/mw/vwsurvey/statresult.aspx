    ...
    <div id="h_main">
        <table border="0" cellspacing="0" style="width: 100%;">
            <tr class="daohang_title">
                <td><div class="info">当前调查问卷有效样本数：<asp:Literal runat="server" ID="litNum"></asp:Literal></td>
                <td style="text-align: left; padding-left: 3px;">
                   <input class="btnlistOver" type="button" value="返回" onclick="history.back()"></input>
