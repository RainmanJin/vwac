<%@ Page Title="" Language="C#" MasterPageFile="~/mw/DefaultDetail.Master" AutoEventWireup="true" CodeBehind="_userdialog.aspx.cs" Inherits="PortalWeb.mw.plan._userdialog" %>
    ...
    <script type="text/javascript">
        function getRadioValue() {
            ...
            if (arr[1] == "") {
                ...
                parent.$("#" + stradio).val(parent.$("#" + stradio).val() + ',' + arr[1]);
            }
