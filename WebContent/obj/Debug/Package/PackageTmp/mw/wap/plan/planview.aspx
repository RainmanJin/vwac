...
<% if (canapply)
   { %>
       ...
       <asp:HiddenField runat="server" ID="hidcourseid" Value="0"/>
    ...
    <div><span>手机号：</span> <input type="text"  ID="txtMobile" MaxLength="25" ReadOnly="True" value="<%=base.CurrentUser.MOBILE %>"/></div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $(".btnsumbit").click(function () {
                ...
                var courseid = $("#<%=hidcourseid.ClientID%>").val();
                if (name == "") {
