...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="header"><div class="menu_control menu_control_h"><a href="#"></a></div><h2>我的培训课程</h2><img src="<%=MW.BasePage.GetWebPath %>/mw/wap/images/header.jpg"/></div>
    <div class="page">
     <div class="main">
...
<button class="close">关闭</button>
  ...
  <ul class="myplan">
      <ctl:JRepeater runat="server" ID="rpt_List">
          <ItemTemplate>
              <li><a href="<%=MW.BasePage.GetWebPath %>/mw/wap/plan/planview.aspx?type=1&id=<%#Eval("ID") %>"><p> <%#Eval("PlanName") %></p><i>培训讲师：<%# Eval("Teacher")%></i><i>培训日期：<%#MW.Common.Utils.GetStandardDate(Eval("BeginTime").ToString()) %></i><i>培训天数：<%#Eval("days") %></i></a></li>
          </ItemTemplate>
      </ctl:JRepeater>
  </ul>
 <div class="clear"></div>
