...
<head>
			...
			function view(id,courseId)
		{
			$.fn.jmodal({
	            ...
	            content: function(body) {
	                body.html('loading...');
	                body.load('viewstudystatus?id='+id+"&courseId="+courseId);
	            },
	...
	<div id="contentwrapper">
		<div id="content_right">
			 	<div class="tt">
					${i18n.operman.coursestudySituation} &nbsp;<span>${i18n.operman.allcourse}:&nbsp;${courseListSize}&nbsp;&nbsp;&nbsp;${i18n.operman.ingcourse}:&nbsp;${ingListSize}</span>
				...
				<ec:table action="" items="courseList" var="var" view="ecan" width="100%"
					...
					<ec:row highlightRow="true">
						...
						<ec:column title="${i18n.operman.doprocess}" property="progress" width="9%" >
							${var.progress==null?"0%":var.progress}%
						</ec:column>
						...
						<ec:column title="${i18n.oper.text}" property="oper" width="8%" filterCell="oper" sortable="false">
							<a href="javascript:view('${var.id}','${var.courseId}');" class="oper">${i18n.operman.viewdetail}</a>&nbsp;
						</ec:column>
					</ec:row>
				</ec:table>
				...
				<ec:table action="courseIndex" items="expCourseList" var="var" view="ecan" width="100%"
					...
					<ec:row highlightRow="true">
						...
						<ec:column title="${i18n.operman.doprocess}" property="progress" width="9%" filterable="false">
							${var.progress==null?"0":var.progress}
						</ec:column>
					</ec:row>
				</ec:table>
