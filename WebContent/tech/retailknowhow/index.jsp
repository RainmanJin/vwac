  ...
  <div class="centerbody centerbox">
    <div id="contentwrapper">
      <div id="content_right">
        <div class="tt">
          ${i18n.appname.mw.sktitemlist} <span class="btn" style="float: right;"> <a href="add">${i18n.button.add}</a>
          </span>
        </div>
        <ec:table action="index" method="get" items="dblist" var="var" view="ecan" width="99%"
          ...
          <ec:row>
            ...
            <ec:column title="加入时间" property="dtCreateTime" cell="date" width="20%" format="yyyy-MM-dd HH:mm"
              filterable="false">${var.dtCreateTime}</ec:column>
