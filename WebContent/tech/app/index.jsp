	...
	function del(id)
		{
			...
			{
				ajaxGet("${ctxPath}/techc/app/del",{"id":id},function(d){
					if(d.success)
						location.reload();
					else
						alert(d.data);
...
<div class="centerbody centerbox">
	...
	<div class="tt">
			...
			<ec:table action="index" method="get" items="appplat" var="var" view="ecan" width="99%"
					...
					<ec:row>
						<ec:column title="${i18n.consumables.name}" property="name" width="120">
							...
							<ecan:SubString content="${var.name}" end="14" fix="..."/>
							</a>
						</ec:column>
