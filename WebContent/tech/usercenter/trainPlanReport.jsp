...
<div class="centerbody centerbox">
		<div style="padding: 10px;">
			<div class="tt">
				${i18n.usercenter.title.trainReport}
			...
			<div style="width: 900px;">
				<div style="height: 25px; line-height: 25px;">
					<span style="float: left;">
						<b class="cBox fill"></b>待分配资源&nbsp;&nbsp;&nbsp;
						<b class="cBox plan"></b>计划中&nbsp;&nbsp;&nbsp;
						<b class="cBox confirm"></b>确定/已完成&nbsp;&nbsp;&nbsp;
						<b class="cBox cancel"></b>已取消
					</span>
					<span style="float: right; margin-right: 200px;">
						${i18n.trainplan.filed.yearValue}:
						<select onchange="location.href='trainPlanReport?year=' + this.value">
				...
				<table cellpadding="0" cellspacing="0">
					<tr valign="top">
						<td width="200">
							<ec:table method="post" items="list" var="var"
							 view="ecan" width="200"
								imagePath="${coreImgPath}/table/*.gif" filterable="false" autoIncludeParameters="false"
								...
								<div class="eXtremeTable">
									<table width="1300" cellspacing="0" cellpadding="0" border="0" class="tableRegion" id="ec_table">
										...
										<%
													...
													{
										%>
												<td class="<%=plan.getStatus()%>">
													<span class="form tips" style="display: none;">
														<b>
															<ecan:viewDto property="name" dtoName="TechTrainCourse" id="<%=plan.getTrainId()%>" />
														</b><br />
														<b><%=plan.getPlanDays()%></b>:<%=plan.getRemark()%>
													</span>
												</td>
										<%
													}
