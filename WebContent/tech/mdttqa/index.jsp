  ...
  <div class="centerbody centerbox">
    <div id="contentwrapper">
      <div id="content_right">
        <div class="tt">
          ${i18n.mdttqa.title} <span class="btn" style="float: right;"> <a href="view">${i18n.button.add}</a>
          </span>
        </div>
          ...
          <ec:row>
            <ec:column title="${i18n.mdttqa.qustion}" property="question" width="45%">
              <a href="view?id=${var.id}"
                style="width: 320px; display: block; height: 25px; line-height: 25px; overflow: hidden;">
                ${var.question} </a>
            </ec:column>
            <%-- 
						...
						--%>
            <ec:column title="${i18n.mdttqa.spec}" property="proType" width="15%" filterCell="droplist"
              filterOptions="DOMAIN_PROTYPE">
              <d:viewDomain value="${var.proType}" domain="PROTYPE" />
            </ec:column>
            <ec:column title="${i18n.i18n.filed.status}" property="status" width="8%" filterCell="droplist"
              filterOptions="DOMAIN_MDTT_PKG_STATUS">
