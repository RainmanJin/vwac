...
$(document).ready(function(){
	initHtmlForm("#ec_ajax", $("#jmodal-container-content"),function(d){});	
			...
			<ec:table tableId="ec_ajax" action="listStudents?year=${param.year}&brand=${param.brand}&week=${param.week}&courseId=${param.courseId}" method="post" items="list" var="var" view="ecan" width="99%"
