	...
	<div id="contentwrapper">
		<div id="content_right">
			...
			<form id="myForm" action=
					...
					</c:choose> method="post" class="form"  enctype="multipart/form-data">
					...
					<c:choose>
   						<c:when test="${dto.name==null}">
   							<li>
								...
								<input type="text" name="name" value="${dto.name}" maxlength="100" style="width: 220px" v="notEmpty" v="notEmpty"/>
								<span class="msg">${i18n.valid.notEmpty}</span>
								<em>*</em>
							</li>
							<li>
								<label>${i18n.scormpkg.filed.name}(iPad)</label>
								<input type="text" name="fixedName" value="${dto.fixedName}" maxlength="100" style="width: 220px" v="notEmpty"/>
								<span class="msg">${i18n.valid.notEmpty}</span>
								<em>*</em>
							</li>
							<li>
							...
							<li><label>${i18n.mdttpkg.filed.status}</label>
								<input type="text" value="${i18n.domainlabel.userstatus.disable}" readonly="readonly" class="gray"/>
							</li>
							<li>
   						...
   						<c:otherwise>
							...
							<!--改造资料库修改标签  -->
							<li style="height: 85px;"><label>${i18n.scormpkg.filed.motorcycle}</label>
									<textarea  id="motorcycle" name="motorcycle" v="notEmpty" style="width: 500px; height: 80px;">${dto.motorcycle}</textarea>
									<span class="msg">${i18n.valid.notEmpty}</span>
							</li>
							<!--改造资料库修改标签  -->
		                    <li><label>${i18n.domains.osType}</label>
							...
							<li><label>${i18n.mdttpkg.filed.status}</label>
								<d:selectDomain domain="MDTT_PKG_STATUS" name="status" value="${dto.status}" />
								<em>*</em>
							</li>
   						</c:otherwise> 
    				</c:choose>
