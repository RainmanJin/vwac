		...
		<div id="contentwrapper">
			<div id="content_right">
				...
				<form id="spForm" action="saveconent" method="post">
					<ul class="form">
						<li><label>${i18n.selling.conent.pointtitle}</label> <input type="hidden" name="id" id="id" value="${dto.id }" /> <input type="hidden" name="mainId" id="mainId" value="${mainId}" /> <input
						...
						<li><label>${i18n.sellingpoint.content}</label> <%--<input type="text" id="content" name="content" value="${dto.content}" v="notEmpty" maxlength="400" style="width: 400px" />
				...
				<div class="btns" style="padding-left: 160px;">
					...
					</span> <span class="btn"> <a href="conentlist">${i18n.button.back}</a>
					</span>
				</div>
			</div>
		</div>
