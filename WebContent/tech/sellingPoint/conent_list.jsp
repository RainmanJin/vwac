...
<script type="text/javascript">
	...
	function preview(id) {
		var url = "${pageContext.request.contextPath}/tech/upload/sellingPoint/"
				+ id + "/index.html";
		//alert(url);
		window.open(url);
	}
	...
	<div class="centerbody centerbox">
		<div id="contentwrapper">
			<div id="content_right">
				<div class="tt">${i18n.sellingpoint.conent}</div>
				...
				<ec:table action="" method="get" items="list" var="var" view="ecan" width="99%" imagePath="${coreImgPath}/table/*.gif" showExports="false">
					<ec:row>
						<ec:column title="${i18n.selling.pointtitle}" property="title" width="32%">
							<a href="editconent?id=${var.id}" style="width: 320px; display: block; height: 25px; line-height: 25px; overflow: hidden;"> ${var.title} </a>
						</ec:column>
						<%-- 
				...
				<div class="btns">
					<span class="btn"> <a href="add_conent">${i18n.button.add}</a>
					</span>
				</div>
