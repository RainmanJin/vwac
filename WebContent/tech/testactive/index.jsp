	...
	<div class="centerbody centerbox">
		<div id="contentwrapper">
			<div id="content_right">
				<div class="tt">${i18n.testactive.title1}</div>
				<ec:table action="" tableId="ec_1" method="get" items="mines" var="var" view="ecan" width="99%" imagePath="${coreImgPath}/table/*.gif" showExports="false">
					<ec:row>
				...
				<div class="btns">
					<span class="btn"> <a href="javascript:add()">${i18n.button.add}</a>
					</span>
				</div>
