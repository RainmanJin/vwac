	...
	<div id="contentwrapper">
		 <div  style="float: left; width: 760px;">
				 ...
				 <table style="margin-left: 390px;height: 140px;" width="350" class="table_border">
				 	...
				 	<tr>
				 		<td class="pleft40">${i18n.operman.usercount }:&nbsp;${userlistSize-1}</td>
				 	</tr>
				 	<tr>
				 		<td class="pleft40">${i18n.operman.activecount }:&nbsp;${activelistSize}</td>
				 	</tr>
				 	<tr>
				 		<td class="pleft40">${i18n.operman.diactivecount}:&nbsp;${userlistSize-activelistSize-1}</td>
				 	</tr>
				 </table>
			 </div>
			  ...
			  <div style="margin-left: 790px;" class="user_cls">
						...
						<a href="${ctxPath}/techc/usercenter/index" class="oper" style="color:blue;">${i18n.appname.profile}</a><br/>
			  </div>
			  <br />
			  <br />
			  <br />
