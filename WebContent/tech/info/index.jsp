...
{
		ajaxGet("${ctxPath}/techc/info/" + type,{"id":id},function(d){
			if(d.success)
				location.reload();
			else
				alert(d.data);
			...
			<div id="content_right">
				<div class="tt">
					<span class="btn" style="float: right;"> <a
						href="view">${i18n.button.add}</a>
					</span>
				</div>
				<ec:table action="" method="get" items="articleList" var="var"
					view="ecan" width="99%" imagePath="${coreImgPath}/table/*.gif"
					showExports="false" filterable="false">
					<ec:row>
						...
						<ec:column title="${i18n.app.categoryname}" property="typeId"
							width="20%">
						</ec:column>
						<ec:column title="${i18n.app.entrydate}" property="createTime"
							width="150px" filterable="false" sortable="false">
						</ec:column>
						<ec:column title="${i18n.oper.text}" property="oper" width="120px"
